...
export class CreateComponent implements OnInit {
  ...
  constructor(
    private taskSend: SendcompdataService,
    private editValue: SendcompdataService,
    private sendDesc: SendcompdataService,
    ) {}
  ...
  saveItem(description: string) {
    return this.sendDesc.takeDescription(description);
  }
}
